...
namespace OnlinePayment.Controllers
{
    ...
    {
        private ElectronicDBContext db = new ElectronicDBContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Type,DeviceName,PurchaseDate,Quantity,CostPrice,SellingPrice,Remarks")] Electronic electronic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Type,DeviceName,PurchaseDate,Quantity,CostPrice,SellingPrice,Remarks")] Electronic electronic)
        {
            if (ModelState.IsValid)
            {
